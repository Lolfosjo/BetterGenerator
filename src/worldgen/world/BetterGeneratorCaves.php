...
class BetterGeneratorCaves extends Generator {
    ...
    public function generateChunk(ChunkManager $world, int $chunkX, int $chunkZ): void {
        ...
        $this->caveGen->carveDirectly($world, $chunkX, $chunkZ);
        $this->caveGen->applyAquifers($world, $chunkX, $chunkZ);
    }
