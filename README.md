##  BetterGenerator Alpha (Shit)

A PocketMine API 5 plugin that adds a so-called "Custom Generator" — written with truly awful, bug-ridden code that has absolutely nothing in common with the real Vanilla Minecraft 1.18 terrain generation.
(It’s also not supposed to have anything to do with the vanilla 1.18 generation)
